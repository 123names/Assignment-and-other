...
class ProducerConsumer3 extends Thread {
    ...
    class Producer extends Thread {
        public void run() {
            while(true) {
                ...
                System.out.println("Producer " + myNumber + " trying to insert");
        ...
        private Item produce_item(){
            ...
            System.out.println("Producer " + myNumber + "  making item " + data);
    ...
    public class Consumer extends Thread {
        public void run() {
            while(true) {
                System.out.println("Consumer " + myNumber + " trying to remove");
        ...
        private void consume_item(Item data){
            System.out.println("Consumer " + myNumber + " used item " + data);
            try{sleep(1000);}
            catch(InterruptedException ex){};
        }
