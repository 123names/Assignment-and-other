...
public class BinaryTree extends BinaryTreeBasis {
  ...
  public BinaryTree(KeyedItem rootItem) {
    super(rootItem);
  }  // end constructor

  public BinaryTree(KeyedItem rootItem,BinaryTree leftTree,BinaryTree rightTree) {
    root = new TreeNode(rootItem, null, null);
    attachLeftSubtree(leftTree);
    attachRightSubtree(rightTree);
  }  // end constructor

  public void setRootItem(KeyedItem newItem) {
    if (root != null) {
