...
public class RSA {
	...
	public static void saveKeyToFile() throws FileNotFoundException{
		File filePri = new File("RSA_PrivateKey.txt");
		File filePub = new File("RSA_PublicKey.txt");
		PrintWriter write = new PrintWriter(filePri);
		write.println(kPrivate);
		write.close();
		PrintWriter write1 = new PrintWriter(filePub);
		write1.println(kPublic);
		write1.close();
	}
